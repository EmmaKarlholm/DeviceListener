...
It is possible to skip the menus to go directly to listening. Supply either of both an `--input 0` and/or `--output 0` argument to immediately set the application to use the stated input and/or output device. Start the program normally to see which numbers correspond to which device on your system.
